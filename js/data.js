...
const SEED_EMPLOYEES = [
  {
    ...
    mentorSkillCategory: ["Leadership Skills", "Technical Skills"],
    menteeCapacity: 8,
...
const DEMO_ACCOUNTS = [
  {
    ...
    password: "Demo@2026",
    id: "demo-mentor-1",
    scenario: "Dual-role: mentoring M. Castillo and, at the same time, being mentored by T. Osei on data storytelling — good for seeing both sides of the Home dashboard and the My Journey switcher.",
    employee: {
      ...
      learningGoals: ["Data storytelling"], learningSkillCategory: ["Technical Skills"], skillLevel: "Beginner",
      offeredSkills: ["Client escalation handling", "Coaching new CSMs"], mentorSkillCategory: ["Behavioural Skills"], menteeCapacity: 4,
      experience: "8 years leading enterprise CX for EMEA hotel groups",
      goalStatement: "Get sharper with data to back up customer health narratives", purpose: "I want to help newer CSMs build confidence handling tough accounts.",
      interests: [], preferredFormat: "mentor", isMentor: true, isMentee: true, deliveryFormat: "Virtual", preferredLanguage: "English", aiConfidence: "Practitioner",
      availability: { frequency: "Bi-weekly", hours: 1, timezone: "GMT (UTC+0)", windows: "Wed afternoons" },
      matchNote: "", engagementStatus: "active", rating: 4.8, menteeCount: 2, consentAck: true, profileComplete: true,
    },
  },
  {
    username: "mentee1",
    ...
    employee: {
      ...
      interests: [], preferredFormat: "mentee", deliveryFormat: "Virtual", preferredLanguage: "English", aiConfidence: "Familiar",
  ...
  },
  {
    ...
    password: "Demo@2026",
    id: "demo-mentee-2",
    scenario: "A mentee already partway through an active journey, who has also explicitly nominated as a mentor (dual-role, but seeded distinctly from mentor1's example): good for exploring My Journey, calendar scheduling, nudges, and Insights with real data already in place.",
    employee: {
      ...
      goalStatement: "Present forecasts to leadership with confidence within 12 weeks", purpose: "Nominated to mentor after getting comfortable with the program as a mentee first.", skillLevel: "Intermediate",
      interests: [], preferredFormat: "mentee", isMentor: true, isMentee: true, deliveryFormat: "Virtual", preferredLanguage: "English", aiConfidence: "Familiar",
  ...
  },
  {
    ...
    employee: {
      ...
      availability: { frequency: "Bi-weekly", hours: 1, timezone: "ET (UTC-5)", windows: "Mon/Wed afternoons" },
      matchNote: "", engagementStatus: "available", rating: 4.7, menteeCount: 1, consentAck: true, profileComplete: true,
    },
  },
  {
    ...
    employee: {
      ...
      matchNote: "", engagementStatus: "available", rating: 4.9, menteeCount: 1, consentAck: true, profileComplete: true,
    },
  },
  {
    username: "newuser1",
...
const PROGRAM_META = {
  ...
  matchWeights: [
    ...
    { key: "complement", label: "Complementary perspective", weight: 0.15 },
    { key: "format", label: "Format & preference fit", weight: 0.10 },
    { key: "availability", label: "Availability / time zone", weight: 0.15 },
    { key: "deliveryFormat", label: "Meeting format fit", weight: 0.05 },
    { key: "language", label: "Language fit", weight: 0.05 },
...
const RESOURCE_LIBRARY = {
  faqs: [
    ...
    },
    {
      ...
      a: "Mentor: you guide someone else, drawing on your own experience. Mentee: someone guides you toward a goal you bring. Peer: two people at a similar level and stage learn from each other, with neither one guiding. Reverse mentoring: someone earlier in their career teaches you something newer, like a tool or a trend, often while you mentor them using your own experience in return.",
    },
    {
  ...
  donts: [
    "Treat it as a one-off session for free advice",
