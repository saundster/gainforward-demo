...
const SEED_EMPLOYEES = [
  ...
  },
  {
    ...
    preferredFormat: "mentee",
    preferredMentorLevel: "principal",
    deliveryFormat: "Virtual",
    preferredLanguage: "Spanish",
    aiConfidence: "Beginner",
...
const DEMO_ACCOUNTS = [
  ...
  },
  {
    ...
    employee: {
      ...
      interests: [], preferredFormat: "mentee", preferredMentorLevel: "senior", deliveryFormat: "Virtual", preferredLanguage: "English", aiConfidence: "Familiar",
  ...
  },
  {
    ...
    employee: {
      fullName: "Elena Vance", displayName: "E. Vance", avatarInitials: "EV", email: "elena.vance@demo.click.app",
      adminRole: "superadmin",
      department: "People Systems", division: "People & Culture", careerLevel: "L5: Director", tenureBand: "5+ yrs", geography: "NA",
      ...
      experience: "Owns the Click platform configuration and the HRIS/SSO integration",
      ...
      matchNote: "", engagementStatus: "active", rating: 4.9, menteeCount: 1, consentAck: true, profileComplete: true,
    },
  },
  {
    username: "newuser1",
    ...
    employee: {
      ...
      interests: [], preferredFormat: "", preferredMentorLevel: "", deliveryFormat: "", preferredLanguage: "", aiConfidence: "",
...
const PROGRAM_META = {
  ...
  matchWeights: [
    { key: "goal", label: "Learning goal ↔ expertise", weight: 0.35 },
    ...
    { key: "mentorLevel", label: "Mentor experience fit", weight: 0.05 },
    { key: "language", label: "Language fit", weight: 0.05 },
    { key: "other", label: "Other preferences", weight: 0.10 },
  ],
  /** Ranks behind "Preferred mentor experience level" (a soft nudge, not a
   * hard filter): a mentee who prefers "senior" still sees a strong L3 match,
   * just ranked a little below an equally-good L4. */
  careerLevelRank: { "L2: Associate": 2, "L3: Senior": 3, "L4: Principal": 4, "L5: Director": 5 },
  mentorLevelMinRank: { mid: 2, senior: 4, principal: 5 },
  matchChecklist: [
